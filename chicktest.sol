...
https://twitter.com/ChicksOnAvax
https://t.me/chicksavax
**/
...
interface IDEXRouter {
    ...
    function swapExactTokensFoCOQINUSupportingFeeOnTransferTokens(
        uint amountIn,
        uint amountOutMin,
        address[] calldata path,
        address to,
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 COQINU = IERC20(0xc06E17bDC3F008F4Ce08D27d364416079289e729); 
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = COQINU.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WAVAX;
        path[1] = address(COQINU);
        ...
        uint256 amount = COQINU.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            COQINU.transfer(shareholder, amount);
...
contract Chicks is IERC20, Auth {
    using SafeMath for uint256;

    address COQINU = 0x420FcA0121DC28039145009570975747295f2329; 
    address WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "CHICKS";
    ...
    address public autoLiquidityReceiver = 0x98dc15fcf2bB3d5911E7EFDC663474839826Ecce;
    address public marketingFeeReceiver = 0x98dc15fcf2bB3d5911E7EFDC663474839826Ecce;
    ...
    uint256 public swapThreshold = _totalSupply * 15 / 1000; // 0.1% of supply
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x98dc15fcf2bB3d5911E7EFDC663474839826Ecce;
        marketingFeeReceiver = 0x98dc15fcf2bB3d5911E7EFDC663474839826Ecce;
    ...
    function swapBack() internal swapping {
        ...
        router.swapExactTokensFoCOQINUSupportingFeeOnTransferTokens(
            amountToSwap,
            0,
            path,
            address(this),
